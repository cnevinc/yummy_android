...
//			Toast.makeText(this, "�L�k�s�����ݦ�A��", Toast.LENGTH_LONG).show();
...
//			String message = "<ol>"
//					+ "<li>��App�ϥΨ쪺��T�ҨӦ�Pixnet�l�Ȩ��A���e���v���ݩ��@�̩Ҧ��C</li>"
//					+ "<li>�Y����ĳ�w��<a href=\"mailto://cnevinchen@gmail.com>\">�g�H����</a></li>"
//	 				+ "<li>�p�Gı�o�٤���A�е��ڭ�<a href='https://play.google.com/store/apps/details?id=com.cgearc.yummy'>�n���</a></li>"
//					+ "<li>�p�G�����w�A�i�H<a href=\"javascript:alert(injectedObject.unistall())\"> �I������Yummy</a></li>"
//					+ "<li>���ڭ̶�Ӱݨ�,��Jemail���ӥi�o�쯫���p§����,<a href=https://docs.google.com/forms/d/1Rviax0Ldl3zWkW5FwOJUYZtFALcgdbqSQdKNG3XtrN4/viewform>�ݤ���i�I��</a></li>"
//					+ "</ol>"
...
//			mSUPAuthor.setText("�P�§A�����,�ϥΦ�App�ΥN��z�P�N�H�U��w");
...
//			final CharSequence[] items = { "�r���Y�� ", " �㭶�Y�� ", " ���ùϤ� " };
//
	...
	public void onBackPressed() {
		...
		if (mSlideUpPanel.isExpanded()) {
			...
			if (this.getFragmentManager().getBackStackEntryCount() == 0) {
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(this);
//				builder.setTitle("�w�g�O�Ĥ@���o");
//				builder.setMessage("�T�w�n���}Yummy��?");
//				builder.setNegativeButton("��F",
//						new DialogInterface.OnClickListener() {
//							@Override
